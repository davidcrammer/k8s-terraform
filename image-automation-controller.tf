resource "kubernetes_manifest" "customresourcedefinition_imageupdateautomations_image_toolkit_fluxcd_io" {
  manifest = {
...
resource "kubernetes_manifest" "serviceaccount_flux_system_image_automation_controller" {
  manifest = {
    "apiVersion" = "v1"
    "kind" = "ServiceAccount"
    "metadata" = {
...
resource "kubernetes_manifest" "deployment_flux_system_image_automation_controller" {
  manifest = {
    "apiVersion" = "apps/v1"
    "kind" = "Deployment"
    "metadata" = {
